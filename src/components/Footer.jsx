  ...
  return (
    <div className='bg-[url("/src/assets/mainbg2.png")] bg-cover bg-left text-[#FCFFF9]'>
        ...
        <div className=' bg-[url("/src/assets/DotGridFooter.png")] bg-contain  bg-center'>
          ...
          <h1 className='text-[30px] leading-[32px] mb-5 w-[312px] md:w-[448px] lg:w-[500px]'>Achieve your business goals today. Book a discovery call now!</h1>
         {/* button */}
             <div className='flex justify-between items-center w-[230px] rounded-4xl p-3 text-[#F7FFEF] bg-linear-150 from-[#2A5EA5] via-[#2A5EA5F2] to-[#006633]'>
               <button className='text-[19px] font-medium uppercase'>Connect</button>
       ...
       <div className='relative mt-8 mb-8'>
        <div className='flex items-center justify-center'><img src="/src/assets/logo.png" alt="logo" className='opacity-25 w-[197px] lg:w-[364px]'/></div>
        <div className="w-full flex items-center justify-center p-5 absolute top-12">
        <h1 className="text-[85px] lg:text-[205px] font-semibold bg-gradient-to-r from-[#92CC7E] via-[#1881B8] to-[#1675A7] bg-clip-text text-transparent">Wisetree</h1>
        </div>
       </div>
       ...
       <div className='flex flex-col items-center justify-center gap-4 p-4'>
        ...
        <p className='text-[16px] text-[#FCFFF9D9] lg:hidden'>© 2024 wisetree. All Rights Reserved.</p>
       ...
       <div className='hidden lg:flex gap-3 cursor-pointer'>
        ...
        <div>
        <p className='hidden text-[16px] text-[#FCFFF9D9] lg:block'>© 2024 wisetree. All Rights Reserved.</p>
        </div>
       </div>
