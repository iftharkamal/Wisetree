    ...
    <>
      ...
      >
        ...
        <motion.img
          ...
          src="/ellipseBlue.png"
          alt="blue"
          className="w-[220px] h-[117px] md:w-[330px] md:h-[190px] lg:w-[420px] lg:h-[270px] absolute top-[97px] left-[-13px] md:left-10 md:top-44  lg:left-10 lg:top-52 xl:left-96 "
        />
        <motion.img
          initial={{ opacity: 0, x: 100 }}
          animate={{ opacity: 1, x: 0 }}
          ...
          alt="green"
          className="w-[220px] h-[117px] md:w-[340px] md:h-[200px] lg:w-[460px] lg:h-[270px] absolute top-[35px] right-[10px] md:right-20 md:top-15 lg:right-10 lg:top-16 xl:top-10 xl:right-72"
        />
        ...
        <div className="relative z-10">
          ...
          <motion.h5
            ...
            className="max-w-[280px] lg:max-w-[330px] font-secondary p-6 text-base lg:text-[18px] leading-[24px] lg:leading-[27px] opacity-85 lg:absolute lg:right-10 lg:top-96 xl:top-96 xl:right-44 "
          >
        ...
        <motion.div
          ...
          className="w-[150px] lg:w-[225px] h-[150px] lg:h-[225px] absolute z-20 rounded-full bg-linear-180 from-[#052842] via-[#2A5EA5] to-[#7BB885] top-[150px] right-[50px] md:top-60 md:right-50 lg:top-64 lg:right-60 xl:right-[670px]"
        >
